    ...
    machineContract: {
      ...
      json: {
        ...
        commonErrorCodes: [
          ...
          'TEMPLATE_VIEW_FAILED',
          'TEMPLATE_VERSION_FAILED',
          'TEMPLATE_TASK_CREATE_FAILED',
          'TEMPLATE_TASK_UPDATE_FAILED',
          'SCHEDULE_CLOUD_GET_FAILED',
          'SCHEDULE_CLOUD_UPDATE_FAILED',
          'SCHEDULE_CLOUD_START_FAILED',
          'SCHEDULE_CLOUD_STOP_FAILED',
          'SCHEDULE_CLOUD_NEXT_FAILED',
          'USER_CONFIG_GET_FAILED',
          'USER_CONFIG_SEARCH_FAILED',
          'USER_CONFIG_SET_FAILED',
