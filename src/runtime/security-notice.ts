 ...
 *
 * This notice applies to proprietary Bazhuayu / Octoparse runtime components,
...
This notice applies to all proprietary Bazhuayu / Octoparse runtime components,
execution engines, loaders, downloaded runtime packages, binary runtimes,
license-checking components, and related protected runtime logic that are used,
downloaded, loaded, invoked, or distributed with or by this CLI.

The proprietary runtime components are owned by Bazhuayu / Octoparse and its
affiliates. They are provided solely for use through officially authorized
Bazhuayu / Octoparse products, services, accounts, and API-key based workflows.
